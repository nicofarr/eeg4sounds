...
if ~exist([resultdir '/oddball/data_ICA'],'dir')   
    mkdir([resultdir '/oddball/data_ICA'])   
end

%%% Checking whether this file has been already inspected 

resultfile_data_ICA = [resultdir, '/oddball/data_ICA/', filetoinspect];
...
data_post_art=ft_preprocessing(cfg,visdata.data); 
...
%%% Load COMP
resultfile_comp = [resultdir '/oddball/ICA_comp/', filetoinspect];
...
cfgerp = [];
cfgerp.demean = 'yes';
avg = ft_timelockanalysis(cfgerp,data_clean);
